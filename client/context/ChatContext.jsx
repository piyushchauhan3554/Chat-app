...
export const ChatProvider = ({ children }) => {
  ...
  const [unseenMessages, setUnseenMessages] = useState({}); // key-value pair :- userId:unSeenMsgs
  ...
  // function to subscribe to messages for selected user : so that we can new messages on real time
